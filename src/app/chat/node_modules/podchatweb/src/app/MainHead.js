...
//UI components
import {ContextTrigger} from "../../../Talk-ui-kit/src/menu/Context";
            ...
            <Fragment>
              ...
              <Container centerLeft>
...

                {
                  ...
                  <Fragment>
                    {
                      (showCallButtons || !isGroup(thread)) && !isChannel(thread) && !supportMode &&
                      <MainHeadCallButtons showCallButtons={showCallButtons} participants={participants} thread={thread} user={user}
                                           smallVersion={smallVersion}/>
                    }
